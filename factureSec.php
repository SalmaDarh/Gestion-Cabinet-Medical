...
<main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Factures</li>
      ...
      <input class="form-control " name="search" style="display:inline; margin-left:200px;width:200px; margin-right:20px;"type="text" placeholder="Chercher un patient" aria-label="Search">
