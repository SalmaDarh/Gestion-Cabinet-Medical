...
<body>
   <h1> Fiche patient</h1>
   <!-- code by ouma -->
   <a href="CompteRendu.php?id=<?php echo $_GET["id"] ?>"style="margin-right:20px;margin-left:450px">Compte rendu   </a>
        <?php echo'    <a style="margin-right:20px" href="ordonnance.php?id='.$data['id'].'" >Ordonnance  </a>' ?>
        <?php echo'    <a style="margin-right:20px" href="certificat.php?id='.$data['id'].'" >Certificat médical   </a>' ?>
        <?php echo'    <a style="margin-right:20px" href="lettre.php?id='.$data['id'].'" >Lettre à un confrère   </a>' ?>
