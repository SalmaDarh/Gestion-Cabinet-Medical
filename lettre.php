...
<main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
    ...
    <li class="breadcrumb-item active" aria-current="page">Lettre à un confrère</li>
  </ol>
        </nav>
<form  class="form-horizontal" method="post" action="lettreBis.php">
...
<div class="form-row">
  ...
  <div class="form-row">  
  <div class="form-group col-md-4">
    <label for="inputname">Confrère</label>
        <input type="text" name="confrere"class="form-control" >
  </div>
</div>

<div class="form-row">  
  <div class="form-group col-md-4">
    <label for="inputname">Contenu</label>
        <textarea rows="5" cols="33" name="contenu" class="form-control" ></textarea>
  </div>
</div>
...
<button type="submit" class="btn btn-primary" href="readPatientMed.php" name="submit">Générer la lettre</button>
        </form>
</main>
