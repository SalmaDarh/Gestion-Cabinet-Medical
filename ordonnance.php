...
<main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
    ...
    <li class="breadcrumb-item active" aria-current="page">Ordonnance</li>
  </ol>
        </nav>
<form  class="form-horizontal" method="post" action="ordonnanceBis.php">
...
<button type="submit" class="btn btn-primary" name="submit">Générer l'ordonnance</button>
        </form>
</main>
